...
- Add `EnableTracing`, a boolean option flag to enable performance monitoring (`false` by default).
   - If you're using `TracesSampleRate` or `TracesSampler`, this option is **required** to enable performance monitoring.
      ...
      ```
- Unify TracesSampler [#498](https://github.com/Cleanshelf/sentry-go/pull/498)
...
- Send errors logged with [Logrus](https://github.com/sirupsen/logrus) to Sentry.
    - Have a look at our [logrus examples](https://github.com/Cleanshelf/sentry-go/blob/master/example/logrus/main.go) on how to use the integration.
- Add support for Dynamic Sampling [#491](https://github.com/Cleanshelf/sentry-go/pull/491)
...
- Do not clone the hub when calling `StartTransaction` [#505](https://github.com/Cleanshelf/sentry-go/pull/505)
    - Fixes [#502](https://github.com/Cleanshelf/sentry-go/issues/502)
...
The new [automatic release detection feature](https://github.com/Cleanshelf/sentry-go/issues/335) makes it easier to use Sentry and separate events per release without requiring extra work from users. We intend to improve this functionality in a future release by utilizing information that will be available in runtime starting with Go 1.18. The tracking issue is [#401](https://github.com/Cleanshelf/sentry-go/issues/401).

## v0.11.0

- feat(transports): Category-based Rate Limiting ([#354](https://github.com/Cleanshelf/sentry-go/pull/354))
- feat(transports): Report User-Agent identifying SDK ([#357](https://github.com/Cleanshelf/sentry-go/pull/357))
- fix(scope): Include event processors in clone ([#349](https://github.com/Cleanshelf/sentry-go/pull/349))
- Improvements to `go doc` documentation ([#344](https://github.com/Cleanshelf/sentry-go/pull/344), [#350](https://github.com/Cleanshelf/sentry-go/pull/350), [#351](https://github.com/Cleanshelf/sentry-go/pull/351))
- Miscellaneous changes to our testing infrastructure with GitHub Actions
  ([57123a40](https://github.com/Cleanshelf/sentry-go/commit/57123a409be55f61b1d5a6da93c176c55a399ad0), [#128](https://github.com/Cleanshelf/sentry-go/pull/128), [#338](https://github.com/Cleanshelf/sentry-go/pull/338), [#345](https://github.com/Cleanshelf/sentry-go/pull/345), [#346](https://github.com/Cleanshelf/sentry-go/pull/346), [#352](https://github.com/Cleanshelf/sentry-go/pull/352), [#353](https://github.com/Cleanshelf/sentry-go/pull/353), [#355](https://github.com/Cleanshelf/sentry-go/pull/355))
...
The `sentryhttp` package got better API docs, an [updated usage example](https://github.com/Cleanshelf/sentry-go/tree/master/example/http) and support for creating automatic transactions as part of Performance Monitoring.
...
- **[breaking]** fix: Rename fasthttp integration package sentryhttp => sentryfasthttp
  ...
  import (
  	...
  	sentryfasthttp "github.com/Cleanshelf/sentry-go/fasthttp"
