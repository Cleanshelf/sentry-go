...
func TestSplitQualifiedFunctionName(t *testing.T) {
	tests := []struct {
		...
		{
			"github.com/Cleanshelf/sentry-go.Init",
			"github.com/Cleanshelf/sentry-go",
			"Init",
		},
		{
			"github.com/Cleanshelf/sentry-go.(*Hub).Flush",
			"github.com/Cleanshelf/sentry-go",
			"(*Hub).Flush",
		},
		{
			"github.com/Cleanshelf/sentry-go.Test.func2.1.1",
			"github.com/Cleanshelf/sentry-go",
			"Test.func2.1.1",
		},
		{
			...
			in: []Frame{
				{
					...
					Module:   "github.com/Cleanshelf/sentry-go/http/integration",
					AbsPath:  "/somewhere/sentry/sentry-go/http/integration/integration.go",
					InApp:    true,
				},
				{
					Function: "(*Handler).Handle",
					Module:   "github.com/Cleanshelf/sentry-go/http",
